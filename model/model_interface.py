...
class MInterface(pl.LightningModule):
    ...
    def lr_scheduler_step(self, scheduler, metric=None):
        # timm's scheduler needs the epoch value and Lightning 2.x calls this hook
        # with (scheduler, metric), so keep the signature aligned with the runtime.
