...
from model.bev_mamba import build_bev_mamba_neck
...
def _resolve_resnet18_ckpt():
    candidates = [
        ...
        PROJECT_ROOT.parent / 'ckpts' / 'resnet18.pth',
    ]
    for ckpt_path in candidates:
        if ckpt_path.exists():
            return ckpt_path
    raise FileNotFoundError(
        'resnet18 checkpoint not found. Put it at '
        f'{candidates[0]} or override the code path.'
    )
